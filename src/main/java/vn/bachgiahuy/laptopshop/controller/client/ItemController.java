...
import vn.bachgiahuy.laptopshop.service.CartService;
...
public class ItemController {
    ...
    public String handleDeleteCartDetail(@PathVariable long id, HttpServletRequest request) {
        HttpSession session = request.getSession(false);
    ...
    public String getProductPage(Model model, ProductCriterialDTO productCriterialDTO, HttpServletRequest request) {
        ...
        Page<Product> prs = this.productService.getAllProductsSpec(pageable, productCriterialDTO);
